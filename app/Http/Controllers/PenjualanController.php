...
class PenjualanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('penjualan.form')->with('success', 'Penjualan berhasil disimpan!');
    }
    public function form()
    {
        $pelanggan = \App\Models\Pelanggan::all();
        $produk = \App\Models\Produk::all();
        return view('penjualan.form', compact('pelanggan', 'produk'));
    }
    public function edit($id)
    {
        ...
        $pelanggan = \App\Models\Pelanggan::all();
        $produk = \App\Models\Produk::all();
        return view('penjualan.edit', compact('penjualan', 'detail', 'pelanggan', 'produk'));
    }
